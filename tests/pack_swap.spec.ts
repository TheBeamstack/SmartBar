...
describe("pack swap — BAEL vs EC2, identical pipeline", () => {
  ...
  it("cover requirement differs (BAEL EXTERIOR 30 vs EC2 EXTERIOR 25+Δ=35) → opposite status at c=30", () => {
    ...
    // c=30 MEETS the BAEL minimum (30) → 🟢 PASS (a cover at the code minimum is compliant); EC2
    // requires 35 so 30 < 35 → 🔴 FAIL. (The §7.12 comfort-target WARN band was reverted — review F1.)
